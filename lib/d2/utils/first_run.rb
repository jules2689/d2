  ...
  module Utils
    class FirstRun
      ...
      class << self
        ...
        def git_run
          git_section = D2::Config.get_section('git')
          ...
          logger.with_frame('Git Integration', timing: false) do
            ...
            if git_section['default_owner'].nil?
              ...
              D2::Config.set('git', 'default_owner', owner)
            end
          end
        end

        def src_path
          return if D2::Config.get('src_path', 'default')
          ...
          logger.with_frame('Code Source Path', timing: false) do
            ...
            D2::Config.set('src_path', 'default', src_path)
          end
        end
      end
    end
